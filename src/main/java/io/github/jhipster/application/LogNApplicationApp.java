...
public class LogNApplicationApp {

    private static final Logger log = LoggerFactory.getLogger(LogNApplicationApp.class);

    private final Environment env;

    public LogNApplicationApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes LogNApplication.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(LogNApplicationApp.class);
